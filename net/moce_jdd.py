...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        random.seed(seed)
        # opt = train_options()
        model = MoCEJDD(rank=2, num_blocks=[2, 4, 6, 8], num_dec_blocks=[2, 3, 4], levels=4, dim=8,
        ...
        # macs, params = get_model_complexity_info(model, (3, 2160, 3840), as_strings=True,
